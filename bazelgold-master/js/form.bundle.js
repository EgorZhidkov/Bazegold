! function(e) {
    ...
    var X, Y = function(e) {
        ...
        Z = function() {
            if (!K) {
                var e = $(window).scrollTop() - $("#section-1--video").offset().top,
                    t = $("#section-1--video").outerHeight();
                e < t ? X.play() : e > t && X.pause()
            }
        };
    n(10), n(3);
    window.$ = window.jQuery = n(11), z = z.destroy(!0), z = new r.a.Controller, $(".section-1").length > 0 && B(), $(".nav-hamburger").click(function() { $(".navbar").toggleClass("active"), $(".navbar").hasClass("active") && q.staggerFromTo(".nav-link", .5, { opacity: 0, y: 200 }, { y: 0, opacity: 1, ease: j.easeOut }, .1) }), $(".nav-link").click(function(e) {
            e.preventDefault();
            var t = $(this).attr("href"),
                n = $(t).offset().top;
            q.to(window, 1.5, { scrollTo: { y: n, autoKill: !1 }, ease: Power2.easeInOut }), $(".navbar").hasClass("active") && $(".navbar").removeClass("active")
        }),
